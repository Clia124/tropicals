...
<section class="shopping-cart">
    ...
    <div class="box-container">
        ...
        if(mysqli_num_rows($select_cart) > 0){
            while($fetch_cart = mysqli_fetch_assoc($select_cart)){
                ?>
                <div  class="box">
                    <a href="cart.php?delete=<?php echo $fetch_cart['id']; ?>" class="fas fa-times" onclick="return confirm('delete from cart?');"></a>
                    ...
                    <form action="" method="post">
                        ...
                        <input type="number" max="2" min="1" value="<?php echo $fetch_cart['quantity']; ?>" name="cart_quantity" class="qty">
                        <input type="submit" value="update" class="option-btn" name="update_quantity">
                    </form>
                    <div class="sub-total"> Total : <span>R<?php echo $sub_total = ($fetch_cart['price'] * $fetch_cart['quantity']); ?></span> </div>
                </div>
                <?php
    ...
    <div class="cart-total">
        <p>Total Amount : <span>R<?php echo $grand_total; ?></span></p>
